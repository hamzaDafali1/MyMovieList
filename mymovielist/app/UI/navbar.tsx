    ...
    return (
        ...
        <div className=" flex flex-row bg-blue-500 w-screen text-white-100 py-3 text-md justify-center items-center h-16">
            ...
            <form className="w-4/6 bg-white">
                <input className=" px-5 py-1 w-6/7  text-blue-500" type="text" placeholder="Search for movies, series and actors" />
                <input className="border px-5 py-1 text-white bg-blue-500 font-medium w-1/7" type="submit" value="Search"/>
            </form>
            </div>
        </div>
    )
